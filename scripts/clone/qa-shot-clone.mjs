...
for (const [name, w, h] of [['desktop-1440', 1440, 900], ['tablet-768', 768, 1024], ['mobile-390', 390, 844]]) {
  ...
  await p.evaluate(async () => { await new Promise((r) => { let y = 0; const s = () => { y += innerHeight * 0.5; scrollTo(0, y); if (y < document.body.scrollHeight) setTimeout(s, 260); else { scrollTo(0, 0); setTimeout(r, 500) } }; s() }) })
